...
//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
					.setFooter('Epic .' , 'https://cdn.discordapp.com/icons/468167578855014411/f0a04c597d33461b6ed5df7d1d0138e9.jpg?size=128')
...
const adminprefixsdsds = "$vip";//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
...
if (message.content.startsWith(adminprefixsdsds + 'setgame')) {//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
  ...
  if (message.content.startsWith(adminprefixsdsds + 'setname')) {
client.user.setUsername(argresult).then
...
if (message.content.startsWith(adminprefixsdsds + 'setT')) {
  client.user.setGame(argresult, "https://www.twitch.tv/idk");
